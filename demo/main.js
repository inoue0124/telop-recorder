...
function submitButtonClicked(e) {
    ...
    if (q_num == num_of_files) {
     ...
     if (String(task_prog) == '10'){
       var URL = 'https://www.gavo.t.u-tokyo.ac.jp/~inoue0124/telop-demo/finish.php';
    ...
    if (task_prog != 11) {
    var URL = 'https://www.gavo.t.u-tokyo.ac.jp/~inoue0124/telop-demo/main.php?u=' + user_id + '&p=' + String(task_prog) + '&t=' + task_name + '&n=' + String(q_num);} 
    window.location.href = URL;
 }
